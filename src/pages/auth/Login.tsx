...
import { Mail, Lock, User, Wind, Zap, Shield, Eye, EyeOff, ChevronRight, Sparkles, Activity } from 'lucide-react'
                ...
                <div className="pt-4">
                  <div className="w-48 h-2 bg-gray-200 rounded-full overflow-hidden mx-auto">
                    <div className={`h-full rounded-full ${
                      isDark ? 'bg-gradient-to-r from-cyan-500 to-blue-500' : 'bg-gradient-to-r from-blue-500 to-cyan-400'
                    } animate-progress`} />
                  </div>
                </div>
              </div>
