...
/**
 * Models gradual degradation (dirty filters, coil fouling, biofilm) and allows
...
public class MaintenanceDegradation {
    ...
    // Tuners
    public void setFanPowerRisePer1000h(double v) {
        this.fanPowerRisePer1000h = v;
    }

    public void setHxLossPer1000h(double v) {
        this.hxLossPer1000h = v;
    }
}
