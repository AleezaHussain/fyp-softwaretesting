...
/**
 * Ancillary loads that become heat in the white space and must be removed by cooling:
...
public class NonITLoads {
    ...
    // Tuners
    public void setLightingKW(double v){ this.lightingKW = v; }
    public void setPeopleKW(double v){ this.peopleKW = v; }
    public void setEnvelopeKW(double v){ this.envelopeKW = v; }

    public void setUpsIdleFrac(double v){ this.upsIdleFrac = v; }
    public void setUpsLossFrac(double v){ this.upsLossFrac = v; }
    public void setPduBaseFrac(double v){ this.pduBaseFrac = v; }
    public void setPduLoadFrac(double v){ this.pduLoadFrac = v; }
}
